...
# -*- coding: utf-8 -*-
"""
Created on Sat Feb  1 13:44:32 2020
...
#    fp = '/home/sx37/DT/DPS/data/'
    ...
    qsz_depart_actual_all = np.ones((ns.n_eps, ns.n_rho))*np.nan
    ...
    for i_eps in range(ns.n_eps):
        for i_rho in range(ns.n_rho):
            ...
            queue_stats = nc._obj_fun(x=Q_opt, ns=ns, sdist=sdist, adist=adist,
                                      shaper='DPS', return_qsz=True, return_qsz_depart=True,
                                      return_byte_oh=True, return_dep_rate=True)
...
#            pdb.set_trace()
            ...
            qsz_depart_actual = queue_stats['queue_sz_depart']
            ...
            qsz_depart_actual_all[i_eps, i_rho] = qsz_depart_actual
    ...
    mat_res['qsz_depart_actual_all_DPS'] = qsz_depart_actual_all
